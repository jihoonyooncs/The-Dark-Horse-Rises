...
<img src="title.GIF" width="900" align="middle">
...
I will try to concisely share the key functions of the game and ![title.GIF![title.gif]({{site.baseurl}}/title.gif)
]({{site.baseurl}}/title.GIF)
